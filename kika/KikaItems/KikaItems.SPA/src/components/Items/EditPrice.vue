...
export default {
    ...
    methods: {
        fetchPrice(){
            let vm = this;
            axios.get(apiUrl + `/items/${this.$route.params.id}/prices/${this.$route.params.priceId}`)
        ...
        onSubmit() {
            ...
            axios.put(apiUrl + `/items/${this.$route.params.id}/prices/${this.$route.params.priceId}`, this.data)
            .then(function (response) {
